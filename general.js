class General {
  ...
  init() {
    ...
    this.trashZone.addEventListener("drop", (e)=>this.handleDrop(e,'trash-zone'));
    this.holderZone.addEventListener("drop", (e)=>this.handleDrop(e,'holder-zone'));
    this.pencilsZone.addEventListener("drop", (e)=>this.handleDrop(e,'pencils-zone'));
    this.basketZone.addEventListener("drop", (e)=>this.handleDrop(e,'basket-zone'));
    this.backpackZone.addEventListener("drop", (e)=>this.handleDrop(e,'backpack-zone'));
    ...
    this.entryButton.addEventListener("click", () => {
      ...
      setTimeout(()=>{
        ...
        this.time.innerText = ''
        this.round = null
        this.round = new Round(this.cozyMP3,this.boomSFX,this.popSFX,this.noSFX,this.timeUpSFX,this.backModal,this.desk,this.time)
        this.interval = null
  ...
  handleDrop(e,place){
     ...
     this.cozyMP3.pause()
      ...
      let object = document.getElementById(data.id);console.log(object);
